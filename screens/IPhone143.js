...
const IPhone143 = () => {
  ...
  const { sharedRecipientName, setSharedRecipientName } = useContext(MyContext);


  const handleSubmit = () => {
    setSharedRecipientName(recipientName);
  };
  ...
  return (
    <View style={styles.iphone143}>
      ...
      <View style={styles.frame2}>
        <View style={styles.frame3}>
            <View style={styles.frame4}>
                <View style={styles.textFields}>
                  <Text style={styles.whoIsThis}>Who are you celebrating with your Bundl book?</Text>
                </View>
                <TextInput
        ...
        <Text style={styles.of3}>1 of 8</Text>
